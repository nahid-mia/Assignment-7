    ...
    return (
        <div className='bg-green-900'>
            <div className='flex flex-col space-y-4 py-20 w-11/12 mx-auto text-center text-white items-center'>
                <Image src={footerLogo} width={300} height={100} alt='Footer-Logo'></Image>
                <p>Your personal shelf of meaningful connections. Browse, tend, and nurture the relationships that matter most.</p>
                <p className="font-semibold text-xl">Social Links</p>
                <ul className='flex gap-2 items-center'>
                    <li><Image src={instagramImg} width={30} height={20} alt='instagram-Icon'></Image></li>
                    <li><Image src={facebookImg} width={30} height={20} alt="facebook-Icon"></Image></li>
                    <li><Image src={twitterImg} width={30} height={20} alt='twitter-Icon'></Image></li>
                </ul>
